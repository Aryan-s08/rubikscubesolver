...
while True:
    ...
    def scan_face_live(face_name, centers):
        """Live webcam feed with 3x3 grid extraction and confirmation."""
        cap = cv2.VideoCapture(0)
        if not cap.isOpened():
            print("Error: Cannot open camera")
            sys.exit()
        ...
        if face_name == "TOP":
            print("Make sure that the face towards camera has a White center, and face on top has a Blue center.")
        if face_name == "RIGHT":
            print("Make sure that the face towards camera has a Red center, and face on top has a White center.")
        if face_name == "LEFT":
            print("Make sure that the face towards camera has a Orange center, and face on top has a White center.")
        if face_name == "BOTTOM":
            print("Make sure that the face towards camera has a Yellow center, and face on top has a Green center.")
        if face_name == "BEHIND":
            print("Make sure that the face towards camera has a Blue center, and face on top has a White center.")
        if face_name == "FRONT":
            print("Make sure that the face towards camera has a Green center, and face on top has a White center.")    
